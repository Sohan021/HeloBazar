...
const agentRegister = (firstname, lastname, mobilenumber, nid_number, postalcode, profilephoto, countryId, divisionId, districtId, upozilaId, unionOrWardId, marketId, password, confirmpassword) => async (dispatch) => {
    debugger
    dispatch({
        type: AGENT_REGISTER_REQUEST, payload: { firstname, lastname, mobilenumber, nid_number, profilephoto, countryId, divisionId, districtId, upozilaId, unionOrWardId, marketId, postalcode, password, confirmpassword }
    });

    try {
        const { data } = await axios.post(base + "/api/agent/addagent", { firstname, lastname, mobilenumber, nid_number, postalcode, profilephoto, countryId, divisionId, districtId, upozilaId, unionOrWardId, marketId, password, confirmpassword });
