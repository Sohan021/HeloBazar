                                        ...
                                        <div className="col-12">
                                            <Card >
                                                    ...
                                                    <ListGroup className="list-group-flush">
                                                        ...
                                                        <ListGroupItem style={{ backgroundColor: "#fff", textAlign: "center" }}><h4>{downline.firstName} {downline.lastName} {downline.phoneNumber}</h4></ListGroupItem>
                                                    </ListGroup>
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <Card>
                                                    ...
                                                    <Link to={"appsharerseconddownlinelist/" + downline.id}>
                                                        <Button
                                                            style={{
                                                                color: "#fff",
                                                                backgroundColor: "#000"
