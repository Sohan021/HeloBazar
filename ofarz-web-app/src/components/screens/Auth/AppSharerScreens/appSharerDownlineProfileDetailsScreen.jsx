    ...
    >
        { sharer ? (
            <Card style={{ color: "#fff", backgroundColor: "#fff", borderColor: "#000", }} >
                ...
                <div className="row">
                    <div className="col-4">
                        <div className="container">
                            ...
                            <br />
                            <br />
                            <h3 style={{ color: "#000", textAlign: "center" }}>Name- {sharer.firstName} {sharer.lastName} </h3>
                        </div>
                    </div>
                    <div className="col-4">
                        <Card style={{ color: "#fff", backgroundColor: "#fff", borderColor: "#000", }}>
                    ...
                    <div className="col-4">
                        <div className="container">
                            ...
                            <br />
                            <br />
                            <h4 style={{ color: "#000" }}>Phone- {sharer.phoneNumber} </h4>
                        </div>
                    </div>
                </div>
                <br />
                <div className="row">
                    <div className="col-6">
                        <Card style={{ color: "#fff", backgroundColor: "#fff", borderColor: "#000", height: "325px" }}>
                            <Card.Body>
