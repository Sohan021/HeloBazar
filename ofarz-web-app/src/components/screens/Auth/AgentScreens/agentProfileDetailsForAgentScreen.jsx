                    ...
                    <div className="col-8">
                        <Card style={{ color: "#fff", backgroundColor: "#fff", borderColor: "#000", }}>
                            <Card.Body>
                                ...
                                <br />
                                <br />
                                <Card.Title style={{ color: "#000", backgroundColor: "#fff", height: "97px" }}><h3>{userInfo.item1.firstName} {userInfo.item1.lastName}</h3></Card.Title>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className="col-4">
                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        <Card style={{ color: "#fff", backgroundColor: "#fff", borderColor: "#000", }}>
                            <Card.Body>
                                <p style={{ color: "#000" }}>________________________________________________</p>
                                <Card.Title style={{ color: "#000", backgroundColor: "#fff" }}><h4>Agent Code: {userInfo.item1.agentCode}</h4></Card.Title>
