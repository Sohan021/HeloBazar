...
import { submitPaymentMainAccountPromotional } from '../../../../../../../actions/Fund/paymentActions';
import { Card, ListGroup, ListGroupItem } from 'react-bootstrap'
import { Link } from 'react-router-dom';
import { Button, CustomInput, Form, FormGroup, Input, Label } from 'reactstrap';

function PaymentMainAccountPromotional(props) {
    ...
    const submitHandler = (e) => {
        ...
        dispatch(submitPaymentMainAccountPromotional(amount, agentPhnNumber, payerId));
                            ...
                            <div className="row">
                                ...
                                <div className="col-8">
                                    <Card style={{ height: "40px", justifyContent: "center", alignItems: "center", color: "#fff", backgroundColor: "#000" }}>
                                        Main Account -- Promotional Product
                                    </Card>
                                    <br />
                                    <br />
                                    <Card style={{ height: "40px", justifyContent: "center", alignItems: "center", color: "#fff", backgroundColor: "#000" }}>
...
export default PaymentMainAccountPromotional;