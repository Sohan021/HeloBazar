...
import { submitPaymentBackShoppingOffer } from '../../../../../../../actions/Fund/paymentActions';
import { Card, ListGroup, ListGroupItem } from 'react-bootstrap'
import { Link } from 'react-router-dom';
import { Button, CustomInput, Form, FormGroup, Input, Label } from 'reactstrap';

function PaymentBackShoppingOffer(props) {
    ...
    const submitHandler = (e) => {
        ...
        dispatch(submitPaymentBackShoppingOffer(amount, agentPhnNumber, payerId));
...
export default PaymentBackShoppingOffer;